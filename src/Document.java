...
public class Document {
	...
	public int countSyllables(String word) {
		int numSyllables = 0;
		Pattern p = Pattern.compile("((a|e\\B|i|o|u|y)+|\\s[b-df-hj-np-tv-z]*e\\b)", Pattern.CASE_INSENSITIVE);
	...
	/**
	 * Get the number of words in the document. "Words" are defined as contiguous
	 * strings of alphabetic characters i.e. any upper or lower case characters a-z
	 * or A-Z
	 *
	 * @return The number of words in the document.
	 */
	public int getNumWords() {
		Pattern p = Pattern.compile("\\W[a-z]", Pattern.CASE_INSENSITIVE);
	 ...
	 * Syllables are defined as: a contiguous sequence of vowels, except for an "e"
	 * at the end of a word if the word has another set of contiguous vowels, makes
	 * up one syllable. y is considered a vowel.
	 * 
	...
	/*
	 * The main method for testing this class. You are encouraged to add your own
	 * tests.
	 */
	public static void main(String[] args) {
		...
		testCase(new Document("sentence, with, lots, of, commas.!  " + "(And some poaren)).  The output is: 7.5."), 15,
				11, 4);
